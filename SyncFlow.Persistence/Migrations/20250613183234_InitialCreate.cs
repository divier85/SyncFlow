        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Phases_Processes_ProcessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessAssignments_Processes_ProcessId",
                        column: x => x.ProcessId,
                        principalTable: "Processes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProcessAssignments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessAssignments_ProcessId",
                table: "ProcessAssignments",
                column: "ProcessId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessAssignments_RoleId",
                table: "ProcessAssignments",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_ProcessAssignments_UserId",
                table: "ProcessAssignments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_RoleId",
